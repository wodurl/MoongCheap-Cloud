...
-   AWS Calculator 월간 상시 운영 비용(720h): **\$726.71/month**

> `$726.71`은 월간 상시 운영 기준이며 실제 프로젝트 지출액과는 다름.
...
따라서 \*\*월간 상시 운영 비용 `$726.71` → 실제 프로젝트 예상 비용 약
...
월 비용 `$726.71` 전체에 `368/720`을 적용하면 안 된다.
...
따라서 `$726.71 × 368/720`은 실제 프로젝트 비용이 아니며, **서비스별
